package be.artex.rolesv5.api.roles.roles.sonic;
...
public class Knuckles extends Role {
    ...
    private static final ItemStack GUI_STACK = ItemBuilder.create(Material.BLAZE_POWDER)
            ...
            .setLore(ChatColor.RESET + "" + ChatColor.DARK_PURPLE + "15% " + ChatColor.RESET + "de chance de mettre en " + ChatColor.GOLD + "feu" + ChatColor.RESET + ".", ChatColor.RESET + "" + ChatColor.RED + "Force " + ChatColor.RESET + "de façon permanente.")
            .build();

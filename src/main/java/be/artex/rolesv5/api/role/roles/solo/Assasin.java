...
public class Assasin extends Role {
    ...
    private static final ItemStack GUI_STACK = ItemBuilder.create(Material.DIAMOND_SWORD)
            ...
            .setLore(ChatColor.RESET + "" + ChatColor.GRAY + "Epée " + ChatColor.AQUA + "Tranchant 4" + ChatColor.GRAY + ".", ChatColor.RESET + "" + ChatColor.RED + "Force " + ChatColor.GRAY + "de façon permanente.")
            .build();

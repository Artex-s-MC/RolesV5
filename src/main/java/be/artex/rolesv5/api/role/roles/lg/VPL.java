package be.artex.rolesv5.api.role.roles.lg;
...
public class VPL extends Role {
    ...
    private static final ItemStack GUI_STACK = ItemBuilder.create(Material.QUARTZ)
            ...
            .setLore(ChatColor.RESET + "" + ChatColor.AQUA + "Vitesse " + ChatColor.GRAY + "de façon permanente.", ChatColor.RESET + "" + ChatColor.RED + "Force " + ChatColor.GRAY + "de façon permanente.")
            .build();
